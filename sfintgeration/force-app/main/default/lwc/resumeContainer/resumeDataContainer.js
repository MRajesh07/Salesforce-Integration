...
export const MyProfileImage = MyImage;
export const Social_Links = [
    {
        type: 'Linkedin',
        label: 'Linkedin/RajeshMathi',
        url: 'https://www.linkedin.com/in/rajesh-mathi-459958222/',
        icon: SOCIAL + '/SOCIAL/linkedin.svg',
    },
    {
        type: 'Trailhead',
        label: 'Trailhead/RajeshMathi',
        url: 'https://trailblazer.me/id/rmathi14',
        icon: SOCIAL + '/SOCIAL/trailhead.svg',
    },
    {
        type: 'certification',
        label: 'certification/RajeshMathi',
        url: '#',
...
export const user_Details = {
    Name: 'Rajesh Mathi',
    Email: 'mathirajesh7773@gmail.com',
    PhoneNumber: '+917013984794',
